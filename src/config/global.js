export default {
  ...
  glosario: [
    ...
    },
    {
      termino: 'REST',
      significado:
        'La Transferencia de Estado Representacional, o REST, es un estilo de arquitectura <em>software</em> para sistemas hipermedia distribuidos, como la World Wide Web.',
    },
  ],
  complementario: [
    {
