...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    figure.mb-5(data-aos="fade-down")
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/96-9j3SSS_0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
      ...
      .col-lg-6(data-aos="fade-left")
        .bg-gris.neg--right.p-lg-4.p-4
          p.mb-0 Para la elaboración de este componente, se abordaron varios autores conocidos en 
            ...
            strong análisis y desarrollo de <em>software</em>.
